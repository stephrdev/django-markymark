    ...
    buttons: [
      [{
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-list-bullet', fa: 'fa fa-list', 'fa-3': 'icon-list-ul' },
          callback: function(e){
        ...
        },
        {
          ...
          hotkey: 'Ctrl+O',
          title: 'Ordered List',
          icon: { glyph: 'glyphicon glyphicon-list-numbered', fa: 'fa fa-list-ol', 'fa-3': 'icon-list-ol' },
          callback: function(e) {
