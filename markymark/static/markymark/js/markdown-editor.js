...
/* ==========================================================
 * THIS IS A VENDOR-COPY WITH LOCAL CHANGES
 *
 *  - Fall back to django.jQuery if window.jQuery is not available.
 *  - provide a alias for jQuery inside Markdown function.
 *  - Fixes for font awesome 5.
 *  - Hide preview button by default.
 *  - Add table button.
 * ========================================================== */
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    ...
    // jQuery plugin
    factory(window.jQuery || window.django.jQuery);
  }
}(function($) {
  "use strict";
  var jQuery = $;
